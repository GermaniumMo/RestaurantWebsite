...
render_document_head('About Us - Savoria Restaurant');

render_header('default', 'about');
?>
        ...
        <div class="d-flex flex-row gap-4">
            ...
            <div class="card" style="border: none;">
                <div class="card-body p-5">
                    <?= $sustainability_icon ?>
                    <h5 class="card-title mb-4 mt-2 coreValues-cardTitle">Sustainability</h5>
            ...
            <div class="card" style="border: none;">
                <div class="card-body p-5">
                    <?= $excellence_icon ?>
                    <h5 class="card-title mb-4 mt-2 coreValues-cardTitle">Excellence</h5>
                    <p class="card-text coreValues-cardText">
            ...
            <div class="card" style="border: none;">
                <div class="card-body p-5">
                    <?= $community_icon ?>
                    <h5 class="card-title mb-4 mt-2 coreValues-cardTitle">Community</h5>
                    <p class="card-text coreValues-cardText">
        ...
        <div class="row row-cols-1 row-cols-md-4 g-5">
            <div class="col">
                <div class="card h-100 justify-content-between align-items-center">
                    <img src="images/about/Sarah Johnson.png" class="card-img-top" style="width: 50%" alt="Sarah Johnson" />
                    <div class="card-body">
                        <h5 class="card-title coreValues-cardTitle text-center">Sarah Johnson</h5>
                        <p class="card-text coreValues-cardText text-center">Executive Chef</p>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card h-100 justify-content-between align-items-center">
                    <img src="images/about/David Williams.png" class="card-img-top" style="width: 50%" alt="David Williams" />
                    <div class="card-body">
                        <h5 class="card-title coreValues-cardTitle text-center">David Williams</h5>
                        <p class="card-text coreValues-cardText text-center">Pastry Chef</p>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card h-100 justify-content-between align-items-center">
                    <img src="images/about/John Martinez.png" class="card-img-top" style="width: 50%" alt="John Martinez" />
                    <div class="card-body">
                        <h5 class="card-title coreValues-cardTitle text-center">John Martinez</h5>
                        <p class="card-text coreValues-cardText text-center">Restaurant Manager</p>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card h-100 justify-content-between align-items-center">
                    <img src="images/about/Michael Doe.png" class="card-img-top" style="width: 50%" alt="Michael Doe" />
                    <div class="card-body">
                        <h5 class="card-title coreValues-cardTitle text-center">Michael Doe</h5>
                        <p class="card-text coreValues-cardText text-center">Head Sommelier</p>
                    </div>
                </div>
            </div>
        </div>
