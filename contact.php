...
// Check for contact success/error messages
$contactSuccess = isset($_SESSION['contact_success']) && $_SESSION['contact_success'];
$contactError = isset($_SESSION['contact_error']) && $_SESSION['contact_error'];
...
<body>
  ...
  <section class="contact-section">
    <div
      class="contact-container d-flex flex-column justify-content-center align-items-center gap-3">
      <h1>Get in Touch</h1>
      <p>
        We'd love to hear from you. Whether you have a question about our menu, want to make a reservation, or need assistance, we're here to help.
      </p>
    </div>
  </section>
  <section>
    ...
    <div class="d-flex justify-content-center contact-container">
      <div class="d-flex w-50 flex-column form-box justify-content-center align-items-center px-4 py-5 rounded-3">  
        ...
        <form action="process_contact.php" method="POST"
          class="d-flex flex-column justify-content-center align-items-center w-100 gap-4">
          <div class="flex-row d-flex w-100 gap-4">
            <input
              type="text"
              name="first_name"
              placeholder="First name"
              class="w-100 bg-transparent p-3 border border-1 rounded-3" required />
              <input
              type="text"
              name="last_name"
